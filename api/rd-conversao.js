...
//   RD_CONVERSION_IDENTIFIER   (opcional) identificador da conversão. Padrão: lp-diagnostico-advocacia
...
module.exports = async function handler(req, res) {
  ...
  const identifier = process.env.RD_CONVERSION_IDENTIFIER || "lp-diagnostico-advocacia";
  ...
  const tags = ["diagnostico-projeto", "nicho-advocacia"];
